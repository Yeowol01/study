...
#pragma region 서식지정자
	...
	// short  <-> 정수형 (2 byte)
	// int    <-> 정수형 (4 byte) 보통 많이씀
	// long   <-> 정수형 (4 byte) OS에 따라서 8 / 4 byte
	// float  <-> 실수형 (4 byte) 
	// double <-> 실수형 (8 byte)
	...
	// 서식 지정자는 각각의 서식에 원하는 데이터를 출력할 수 있으며,
	// 서식과 변수의 형태가 일치하지 않으면 원한느 값이 출력되지 않습니다.
